        """
        Parquet Converter Hd5oen
        ========================
        Open-source data utility that aggregates tabular data across multiple formats.
...
from pathlib import Path
        ...
        APP_NAME    = "Parquet Converter Hd5oen"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source data utility that aggregates tabular data across multiple formats.")
